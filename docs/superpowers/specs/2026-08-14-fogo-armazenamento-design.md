...
Quando `chuveiros_intraprateleiras` for `True`, exigir `area_porta_paletes_m2 <= 3700`, conforme 4.6.1. Para altura de armazenamento superior a 7,6 m, exigir `vazao_intraprateleira_Lmin >= 115`, conforme 6.3.4.3.1.
