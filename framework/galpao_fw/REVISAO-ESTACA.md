...
Reportado ao lado do P_adm global.

### Teixeira (1996) — 3º método (cross-check α/β), Tab.12.16 verbatim

Método SPT com coeficientes **α** (ponta) e **β** (fuste), lido do PDF (pg.290):
```
q_ponta = α·N_p    (α tf/m² por solo × tipo de estaca ; ×10 → kPa ; 4≤N≤40)
r_lateral = β·N_méd (β tf/m² por tipo de estaca)
```
**α [tf/m²]** (colunas I/II/III/IV = pré-moldada·perfil / Franki / escavada / raiz):
argila siltosa 11/10/10/10 · silte argiloso 16/13/11/11 · argila arenosa 21/18/13/14
· silte arenoso 26/21/16/16 · areia argilosa 30/24/20/19 · areia siltosa 36/30/24/22
· areia 40/34/27/26 · areia c/ pedregulho 44/38/31/29. **β [tf/m²]:** I=0,4 · II=0,5
· III=0,4 · IV=0,6. **FS:** tipos I/II/IV → global 2,0; tipo III (escavada) →
R_lat/1,3 + R_ponta/4,0 (recomendação de Teixeira). Os **3 métodos** entram no
relatório (ref: Aoki 1600 / Décourt 1272 / Teixeira 1272 kN — banda apertada).
...
4. **Bloco**: tirante (22.3.3) + **biela comprimida** (22.3.2) + **ancoragem do
   ...
   carga total (sem alívio, conservador): `τsd=N/(u·d) ≤ τrd1` (NBR 6118 19.5.3.2)
   em **dois contornos** — pilar (punciona ↓) e cada estaca (punciona ↑, CEB/Blévot).
