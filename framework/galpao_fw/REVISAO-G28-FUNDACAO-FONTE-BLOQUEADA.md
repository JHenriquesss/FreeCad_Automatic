...
| `tcc-exemplo-ufmg-2023-galpao-24x36__CONCORDANCIA-CALCULISTAS__NAO-E-OBRA-REAL` | `tcc_academico` (exemplo sintético) | **Não** | `tests/fixtures/fonte_exemplo_sintetica/` (G35: movido de `fontes_externas/`; URL example.com dá 404) — demonstração do protocolo G24, não fonte real. |
