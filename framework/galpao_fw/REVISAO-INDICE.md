...
| 40 | Cortante da alma com mesas inclinadas (barra tapered) — fecha dívida (a) da fase 6.b | [REVISAO-CORTANTE-TAPERED.md](REVISAO-CORTANTE-TAPERED.md) | Equilíbrio (mecânica) — NÃO-NBR; Anexo J (J.1–J.4) não trata cortante, J.1.2→§5.4.3 (prova verbatim) | 🟡 PENDENTE SÊNIOR (2026-07-12) — `V_alma=V−(M/h)(dh/dx)`; adverso sempre contado, alívio favorável OPT-IN (default conservador); ref 20×10 intocada (dh/dx=0) |
| 41 | Vento por zona (por água) na tesoura — fecha dívida (c) da fase 6.b | [REVISAO-VENTO-ZONA-TESOURA.md](REVISAO-VENTO-ZONA-TESOURA.md) | NBR 6123 Tabela 5 (Cpe barlavento/sotavento simultâneos) — `cpe_telhado` homologado (item 27) + NBR 8681 | 🟡 PENDENTE SÊNIOR (2026-07-12) — cada água seu Cpe (estado real) em vez de `min` uniforme (fictício); envelope 2 direções; economia real (u 1,04→0,96); back-compat + override preservados |
| 42 | Cross-check DG25 da FLT de mísula (VALIDAÇÃO, não dimensionamento) — fecha dívida (b) da fase 6.b | [REVISAO-DG25-CROSSCHECK.md](REVISAO-DG25-CROSSCHECK.md) | AISC Design Guide 25 §5.4.3 (M_eLTB elástico, F4-5; pág 60–61 verbatim por imagem) vs NBR 8800 Anexo J | 🟡 PENDENTE SÊNIOR (2026-07-12) — INFORMATIVO, não altera dimensionamento (segue NBR item 36); prismático converge 0,998 (F4-5≡F2); tapered DIVERGE 0,54/0,45 (seção meio×funda, não erro de util) |
