...
| 43 | Enrijecedores transversais da alma (painel do joelho) — fecha dívida (e) da fase 6.b | [REVISAO-ENRIJECEDOR-PAINEL.md](REVISAO-ENRIJECEDOR-PAINEL.md) | NBR 8800 §5.4.3.1 (kv=5+5/(a/h)², V_Rd; §5.4.3.1.3 b/t, I_st≥a·tw³·j, j=[2,5/(a/h)²]−2≥0,5; pág 50–51 verbatim por imagem) | 🔵 PARECER RESPONDIDO (2026-07-13) — acertos validados; **1 acolhido** (`a_min→a_max`, bug de nome); **eixo I singelo:** norma refutada (NBR §5.4.3.1.3c = plano médio p/ ambos, verbatim) + mérito acolhido (`ist_singelo` na face, conservador); **campo de tração refutado** (§5.4.3.2 = tubular, não tension field; NBR não tem) |
| 44 | DG25 full — Cb tapered (5.4-1/2) + Mn nominal completo (Rpc/Rpg/F_L/3 regiões) — refino do item 42 | [REVISAO-DG25-FULL.md](REVISAO-DG25-FULL.md) | AISC Design Guide 25 §5.4.1–5.4.3 (5.4-1..5.4-21; pág 58–62 verbatim por imagem) vs NBR 8800 Anexo J/G | ⏳ AGUARDA PARECER (2026-07-13) — cross-check de CAPACIDADE (Cb NÃO cancela); prismático 0,951 (curva inelástica White-Kim ≠ Anexo G ~5%); INFORMATIVO, dimensionamento segue NBR |
