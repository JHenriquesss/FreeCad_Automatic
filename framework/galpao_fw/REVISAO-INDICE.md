...
| 43 | Enrijecedores transversais da alma (painel do joelho) — fecha dívida (e) da fase 6.b | [REVISAO-ENRIJECEDOR-PAINEL.md](REVISAO-ENRIJECEDOR-PAINEL.md) | NBR 8800 §5.4.3.1 (kv=5+5/(a/h)², V_Rd; §5.4.3.1.3 b/t, I_st≥a·tw³·j, j=[2,5/(a/h)²]−2≥0,5; pág 50–51 verbatim por imagem) | ⏳ AGUARDA PARECER (2026-07-13) — relaxa cap h/tw≤260 do Anexo H quando a/h≤3; informativo/opt-in; `a=None`⇒kv=5 byte-idêntico |
