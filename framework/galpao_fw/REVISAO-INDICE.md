...
| 7 | Base (placa + chumbadores) | [REVISAO-BASE.md](REVISAO-BASE.md) | NBR 8800 + AISC DG1 + ACI 318 | ✅ HOMOLOGADO r2 · ✅ ancoragem §9 · ✅ cone ACI §10 · 🆕 cortante-tríade §11 (Fakury) PENDENTE |
...
| 🆕 Cortante-tríade (atrito+chumbador+chaveta) | base | NBR 8800 (Fakury cap.11) | [BASE §11](REVISAO-BASE.md) — PENDENTE |
...
(estaca/tubulão); sismo (NBR 15421).
