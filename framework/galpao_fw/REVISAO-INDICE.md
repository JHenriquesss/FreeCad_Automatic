...
| 44 | DG25 full — Cb tapered (5.4-1/2) + Mn nominal completo (Rpc/Rpg/F_L/3 regiões) — refino do item 42 | [REVISAO-DG25-FULL.md](REVISAO-DG25-FULL.md) | AISC Design Guide 25 §5.4.1–5.4.3 (5.4-1..5.4-21; pág 58–62 verbatim por imagem) vs NBR 8800 Anexo J/G | ✅ HOMOLOGADO — validação (2026-07-13) — "matematicamente validado; sanity-check adequado"; `γ·f_r=F_eLTB` "mais elegante"; 5% inelástico = diferença de método (confirmado); 3 apontamentos de escopo (F_L monossim. **já coberto** 5.4-15; sinais Cb documentados; aw≤10 reflete DG25) |
