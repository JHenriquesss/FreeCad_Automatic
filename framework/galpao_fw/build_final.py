# ============================================================================
# build_final.py - SCRIPT AVULSO (nao e importado por ninguem, de proposito).
# Demo ponta-a-ponta do pipeline LEGADO de galpao de aco: calc
# (rodar_projeto.calcular) -> memorial PDF (relatorio_calculo) -> 3D
# (montar_modelo) -> executivo (rodar_executivo). Serve de amostra manual do
# caminho completo; o caminho de PRODUCAO e o Project Loop (project_loop_cli).
# Rodar: python build_final.py
# ============================================================================
"""Demo ponta-a-ponta do pipeline legado de galpao. Script avulso."""
