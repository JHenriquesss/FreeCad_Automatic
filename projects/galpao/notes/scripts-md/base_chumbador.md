...
Gerado: 2026-07-05  
Base: NBR 8800 6.3 (chumbadores) e 6.6.5 (concreto) + AISC DG1 (placa sob M).
PARAMETRICO: rotulada (M=0) ou engastada (M/=0).
...
LIGACAO DE BASE (placa + chumbadores) - NBR 8800 6,3/6,6 + AISC DG1
  ...
  Tracao total = 132,9 kN -> por chumbador Ft,Sd=66,4 kN ; Fv,Sd=6,5 kN
  Concreto: sigma_max=2672 kN/m2 -> u=0,11
  Chumbador: tracao u=0,95 ; corte u=0,17 ; interacao (Ft/FtRd)^2+(Fv/FvRd)^2 = 0,94
  Placa: t_req=15,3 mm ; t_adotada=25 mm
  -> OK
  [FLAG] Cone de arrancamento/ancoragem do concreto: NBR 6118/ACI 318
         (projeto de fundacao) - NAO verificado aqui.
```
