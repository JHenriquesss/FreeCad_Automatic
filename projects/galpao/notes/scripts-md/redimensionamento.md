...
Criterio: interacao ELU <= 1,00 (NBR 8800, K=1 com 2a ordem) E
          flecha lateral <= H/150 = 40,0 mm (telha metalica).
Travamento lateral: coluna Lb=2,00 m ; viga Lb=1,67 m.
Esforcos de 2a ordem (MAES + rigidez 0,8 + forca nocional).

  Coluna    Viga |  B2max |   flecha    lim | int.col int.viga | resultado
--------------------------------------------------------------------------
  HEA200  HEA180 |  1,036 |    30,8mm  40,0 |    0,67     0,87 | PASSA
  HEB200  IPE300 |  1,017 |    16,3mm  40,0 |    0,42     0,43 | PASSA
  HEB220  IPE330 |  1,012 |    11,5mm  40,0 |    0,33     0,33 | PASSA
  HEB240  IPE360 |  1,009 |     8,3mm  40,0 |    0,26     0,26 | PASSA
  HEB260  IPE400 |  1,006 |     6,1mm  40,0 |    0,21     0,20 | PASSA
--------------------------------------------------------------------------

ADOTADO (mais leve que passa): COLUNA HEA200 + VIGA HEA180
  B2,max = 1,036 ; flecha = 30,8 mm (<= 40,0) ; interacao coluna = 0,67 ; viga = 0,87

OBS: propriedades dos perfis A CONFIRMAR no catalogo do fornecedor.
     Base engastada exige verificar a fundacao/chumbadores ao momento.
```
